...
*dfms* is in a stable state of development, with some degree of active
subsequent development as envisioned by the primary authors.

This outlines how to propose a change to dfms.
...
issue. If you’ve found a bug, please file an issue that illustrates the
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/dfms", fork = TRUE)`.
...
Please note that the dfms project is released with a [Contributor Code
of Conduct](https://docs.ropensci.org/dfms/CODE_OF_CONDUCT.md). By
